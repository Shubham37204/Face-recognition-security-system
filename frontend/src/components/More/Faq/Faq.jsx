...
import video1 from './video1.mp4'; // Import video files
import video2 from './video2.mp4';
import v1 from './v1.jpeg'; // Import image files
...
const Faq = () => {
  ...
  return (
    <div className="container7" style={{ "marginTop": "2pc" }}>
      <div className="video-container">
        <img src={v1} alt="Video Thumbnail 1" className="thumbnail" />
        <div className="play-button" onClick={() => playVideo(video1)}></div>
      </div>

      <div className="video-container">
        <img src={v2} alt="Video Thumbnail 2" className="thumbnail" />
        <div className="play-button" onClick={() => playVideo(video2)}></div>
      </div>
            ...
            <ul className>
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                    <h4 className="text-md leading-6 font-medium text-gray-900">Is facial recognition secure?</h4>
                  </div>
                </div>
                <div className="flex flex-row items-start">
                  <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">Yes, facial recognition on Facial Recognition Security System is secure. We implement robust encryption and access controls to protect user data, and our system undergoes regular security assessments to identify and address potential vulnerabilities.
                    </p>
                  </div>
              ...
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                    <h4 className="text-md leading-6 font-medium text-gray-900">Can I use Facial Recognition Security System on different devices?</h4>
                  </div>
                </div>
                <div className="flex flex-row items-start">
                  <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">Yes, Facial Recognition Security System is designed to be compatible with various devices and platforms. Whether you're using a desktop computer, laptop, tablet, or smartphone, you can access Facial Recognition Security System seamlessly.
                    </p>
                  </div>
                  <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                    <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style={{ enableBackground: 'new 0 0 295.238 295.238' }} xmlSpace="preserve">
              ...
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                    <h4 className="text-md leading-6 font-medium text-gray-900">Is my facial data stored securely?</h4>
                  </div>
                </div>
                <div className="flex flex-row items-start">
                  <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">Absolutely. We take the privacy and security of your facial data seriously. Your facial data is encrypted and stored securely in our database, and we adhere to strict privacy policies to ensure that your data remains confidential.
              ...
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                    <h4 className="text-md leading-6 font-medium text-gray-900">Can I trust Facial Recognition Security System with my personal information?</h4>
                  </div>
                </div>
                <div className="flex flex-row items-start">
                  <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">We prioritize the protection of your personal information. Facial Recognition Security System adheres to strict data protection regulations and privacy policies to safeguard your data. We never share your information with third parties without your consent.
                    </p>
                  </div>
                  <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                    <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style={{enableBackground: 'new 0 0 295.238 295.238'}} xmlSpace="preserve">
              ...
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                    <h4 className="text-md leading-6 font-medium text-gray-900">What if I need help or encounter an issue with Facial Recognition Security System?</h4>
                  </div>
                </div>
                <div className="flex flex-row items-start">
                  <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">Yes, Facial Recognition Security System offers solutions for both personal and commercial use. Whether you're an individual looking to enhance your personal security or a business seeking to implement facial recognition technology, Facial Recognition Security System has solutions tailored to your needs.
                    </p>
                  </div>
                  <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                    <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style={{enableBackground: 'new 0 0 295.238 295.238'}} xmlSpace="preserve">
              ...
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                    <h4 className="text-md leading-6 font-medium text-gray-900">What measures does Facial Recognition Security System take to protect against unauthorized access?</h4>
                  </div>
                </div>
                <div className="flex flex-row items-start">
                  <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">Facial Recognition Security System employs multiple layers of security measures to protect against unauthorized access. This includes encryption, multi-factor authentication, and continuous monitoring for suspicious activity. We're committed to ensuring the utmost security for our users.
                    </p>
                  </div>
                  <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                    <svg height="25px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 295.238 295.238" style={{enableBackground: 'new 0 0 295.238 295.238'}} xmlSpace="preserve">
