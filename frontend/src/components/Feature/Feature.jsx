...
const Feature = () => {
    return (
        <div style={{ marginTop: '2pc' }}>
            <div className="w-full pt-12 p-4" style={{ height: "60vh" }}>
                <div className="grid gap-14 md:grid-cols-3 md:gap-10">
                    <div className="rounded-xl bg-white p-6 text-center shadow-lg border border-gray-200">
                        ...
                        <h1 className="text-darken mb-3 text-xl font-medium lg:px-14">Advanced Facial Recognition</h1>
                        <p className="px-4 text-gray-500">Experience cutting-edge facial recognition technology ensuring swift and secure access.</p>
                    </div>
                    <div className="rounded-xl bg-white p-6 text-center shadow-lg border border-gray-200">
                        ...
                        <h1 className="text-darken mb-3 text-xl font-medium lg:px-14 ">Multi-factor Authentication</h1>
                        <p className="px-4 text-gray-500"> Enjoy peace of mind with seamless integration of multiple layers of authentication for heightened security.</p>
                    </div>
                    <div className="rounded-xl bg-white p-6 text-center shadow-lg border border-gray-200">
                        ...
                        <h1 className="text-darken mb-3 text-xl font-medium lg:px-14 ">Personalized Experiences</h1>
                        <p className="px-4 text-gray-500"> Elevate user experiences with personalized solutions tailored to individual preferences and requirements.</p>
                    </div>
                    <div className="rounded-xl bg-white p-6 text-center shadow-lg border border-gray-200">
                        <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full shadow-lg bg-sky-500 shadow-sky-500/40">
                            <svg viewBox="0 0 55 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white">
                        ...
                        <h1 className="text-darken mb-3 text-xl font-medium lg:px-14 ">Effortless Authentication</h1>
                        <p className="px-4 text-gray-500">Say goodbye to cumbersome passwords with hassle-free facial authentication for seamless access.</p>
                    </div>
                    <div className="rounded-xl bg-white p-6 text-center shadow-lg border border-gray-200">
                        <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full shadow-lg bg-sky-500 shadow-sky-500/40">
                            <svg viewBox="0 0 55 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white">
                        ...
                        <h1 className="text-darken mb-3 text-xl font-medium lg:px-14 ">Real-time Monitoring</h1>
                        <p className="px-4 text-gray-500">Stay ahead with instant alerts and real-time monitoring for proactive security measures.</p>
                    </div>
                    <div className="rounded-xl bg-white p-6 text-center shadow-lg border border-gray-200">
                        <div className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full shadow-lg bg-sky-500 shadow-sky-500/40">
                            <svg viewBox="0 0 55 44" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white">
                        ...
                        <h1 className="text-darken mb-3 pt-3 text-xl font-medium lg:h-14 lg:px-14">Scalability: </h1>
                        <p className="px-4 text-gray-500">Grow without limits with scalable solutions capable of adapting to evolving user demands and business needs</p>
                    </div>
                </div>
            </div>
        </div>
