  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-6 gap-4 head">
        <div class="col-start-2 col-span-4">Get in Touch</div>
      </div>
      ...
      <section className="set">
        <div class="grid grid-rows-3 grid-flow-col gap-4">
          ...
          <div class="row-span-2 col-span-2">Ranchi,Jhakhand</div>
        </div>
        <div class="grid grid-rows-3 grid-flow-col gap-4">
          <div class="row-span-3"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
          </svg>
          </div>
          <div class="row-span-2 col-span-2">(+91)123456789</div>
        </div>
        <div class="grid grid-rows-3 grid-flow-col gap-4">
          <div class="row-span-3"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 9v.906a2.25 2.25 0 0 1-1.183 1.981l-6.478 3.488M2.25 9v.906a2.25 2.25 0 0 0 1.183 1.981l6.478 3.488m8.839 2.51-4.66-2.51m0 0-1.023-.55a2.25 2.25 0 0 0-2.134 0l-1.022.55m0 0-4.661 2.51m16.5 1.615a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V8.844a2.25 2.25 0 0 1 1.183-1.981l7.5-4.039a2.25 2.25 0 0 1 2.134 0l7.5 4.039a2.25 2.25 0 0 1 1.183 1.98V19.5Z" />
          </svg>
          </div>
          <div class="row-span-2 col-span-2">facerecdec@gmail.com</div>
        </div>
      </section>

      <div>
        <div className="min-w-screen min-h-screen flex items-center justify-center px-5 py-5" style={{ marginTop: "4pc" }}>
            ...
            <div className="md:flex w-full">
              ...
              <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div className="text-center mb-10">
                  ...
                  <p>Enter your information and Query</p>
                </div>
                <div>
                  <form action="contact" method="post" id="contact" onSubmit={handleSubmit}>
                    <div className="flex -mx-3">
                      <div className="w-1/2 px-3 mb-5">
                        ...
                        <div className="flex">
                          ...
                          <input type="text" name="fname" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John" />
                        </div>
                      </div>
                      <div className="w-1/2 px-3 mb-5">
                    ...
                    <div className="flex -mx-3">
                      <div className="w-full px-3 mb-12">
                        <label htmlFor className="text-xs font-semibold px-1">Subject</label>
                        <div className="flex">
                          ...
                          <textarea id="textArea" name="message" rows="4" cols="10" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Please Tell us about the Issue.." />
                        </div>
                      </div>
                    </div>
                    <div className="flex -mx-3">
                      <div className="w-full px-3 mb-5">
                      <button className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">SEND</button>
                      </div>
                    </div>
                  </form>
                </div>
